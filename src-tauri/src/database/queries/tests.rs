...
mod tests {
    ...
    async fn setup_test_db() -> DatabasePool {
        ...
        let pool = sqlx::SqlitePool::connect(&db_url).await.expect("Failed to connect to test database");
        crate::database::run_migrations(&pool).await.expect("Failed to run migrations");
        pool
    }
    ...
    fn test_sqlx_compile_time_safety() {
        ...
        assert!(true, "If this compiles, SQLx compile-time safety is working");
    }
    ...
    fn test_type_safety() {
        ...
        assert!(true, "Type annotations ensure correct NULL/NOT NULL mappings");
    }
    ...
    async fn test_create_competitor() {
        ...
        let competitor = create_competitor(&pool, request).await
    ...
    async fn test_get_competitor_by_id() {
        ...
        let created = create_competitor(&pool, request).await
            .expect("Failed to create competitor");
        
        let retrieved = get_competitor_by_id(&pool, &created.id).await
    ...
    async fn test_get_all_competitors() {
        ...
        for request in requests {
            create_competitor(&pool, request).await
                .expect("Failed to create competitor");
        }
        
        let competitors = get_all_competitors(&pool).await
    ...
    async fn test_update_competitor() {
        ...
        let competitor = create_competitor(&pool, create_request).await
            .expect("Failed to create competitor");
        ...
        update_competitor(&pool, &competitor.id, update_request).await
            .expect("Failed to update competitor");
        
        let updated = get_competitor_by_id(&pool, &competitor.id).await
    ...
    async fn test_delete_competitor() {
        ...
        let _ = get_competitor_by_id(&pool, &competitor.id).await
            .expect("Competitor should exist before deletion");
        
        // Delete competitor
        delete_competitor(&pool, &competitor.id).await
        ...
        assert!(result.is_err(), "Competitor should not exist after deletion");
    }
    ...
    async fn test_create_contest() {
        ...
        let contest = create_contest(&pool, new_contest).await
    ...
    async fn test_get_contest_by_id() {
        ...
        let created = create_contest(&pool, new_contest).await
            .expect("Failed to create contest");
        
        let retrieved = get_contest_by_id(&pool, &created.id).await
    ...
    async fn test_get_all_contests() {
        ...
        for new_contest in contests_data {
            create_contest(&pool, new_contest).await
                .expect("Failed to create contest");
        }
        
        let contests = get_all_contests(&pool).await
    ...
    async fn test_update_contest() {
        ...
        update_contest(&pool, &contest.id, updated_contest).await
            .expect("Failed to update contest");
        
        let updated = get_contest_by_id(&pool, &contest.id).await
    ...
    async fn test_contest_status_and_archiving() {
        ...
        let retrieved = get_contest_by_id(&pool, &contest.id).await
            .expect("Failed to get contest")
            .expect("Contest should exist");
        ...
        update_contest(&pool, &contest.id, archived_contest).await
            .expect("Failed to archive contest");
        
        let archived = get_contest_by_id(&pool, &contest.id).await
    ...
    async fn test_competitor_contest_integration() {
        ...
        let competitor = create_competitor(&pool, competitor_request).await
            .expect("Failed to create competitor");
        ...
        let retrieved_competitor = get_competitor_by_id(&pool, &competitor.id).await
            .expect("Failed to get competitor");
        let retrieved_contest = get_contest_by_id(&pool, &contest.id).await
            .expect("Failed to get contest")
            .expect("Contest should exist");
        ...
        let contest_result = get_contest_by_id(&pool, &contest.id).await
            .expect("Query should succeed");
    ...
    async fn test_get_nonexistent_competitor() {
        ...
        assert!(result.is_err(), "Should return error for non-existent competitor");
    }
    ...
    async fn test_get_nonexistent_contest() {
        ...
        let fake_id = "non-existent-id";
        let result = get_contest_by_id(&pool, fake_id).await
            .expect("Query should not error");
        
        assert!(result.is_none(), "Should return None for non-existent contest");
    }
    ...
    async fn test_contest_date_ordering() {
        ...
        assert_eq!(contests[0].date, NaiveDate::from_ymd_opt(2024, 12, 31).unwrap());
        assert_eq!(contests[1].date, NaiveDate::from_ymd_opt(2024, 6, 15).unwrap());
        assert_eq!(contests[2].date, NaiveDate::from_ymd_opt(2024, 1, 1).unwrap());
    }
}